...
class NavBar extends Component {
      ...
      return (
        <div className="btn-group">
          ...
          <div className="dropdown-menu">
            <div className="dropdown-item itemMen" onClick={this.clickCreate}>
              Sugerir Tip
            </div>
  ...
  render() {
    return (
      <div className="topnav flexbox" id="navBar">
        <img
          className="logo"
        ...
        ></img>
        <img
          className="logoChiquito"
          src="/images/logo_andes.png"
          alt="disc"
          onClick={() => this.props.history.push("/")}
        ></img>
        {this.props.show && (
          <button
            ...
            className="btn btn-primary"
            style={{
              backgroundColor: "rgb(70, 157, 204)",
              borderColor: "rgb(70, 157, 204)",
            }}
